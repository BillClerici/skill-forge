...
class AccountAdmin(admin.ModelAdmin):
    list_display = ['account_id', 'account_type', 'subscription_tier', 'subscription_status', 'current_player_count', 'created_at']
    ...
    fieldsets = (
        ('Basic Information', {
            'fields': ('account_id', 'account_type', 'account_owner_player_id')
        }),
        ('Subscription', {
